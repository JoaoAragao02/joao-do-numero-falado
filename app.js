...
function verificarChute() { //usaremos essa função para verificar o chute
...
function gerarNumeroAleatorio() { //usaremos essa função para gerar um número aleatório
    let numerEscolhido = parseInt(Math.random() * numeroLimite + 1);
    let quantidadeDeElementosNaListas = listaDeNumerosSorteados.length;
